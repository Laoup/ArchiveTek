...
** Last update Sun May  3 22:43:00 2015 pierre jallut
*/
...
int		print_turn(t_fourmiz *, t_1001 **, SDL_Surface *);
int		add_room(t_fourmiz *, char *, int *);
...
void		simple_repart_ants(t_fourmiz ***,
				   t_1001 **);
